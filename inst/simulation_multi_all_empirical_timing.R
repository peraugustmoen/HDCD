...
result = foreach(z = 1:N,.options.snow = opts) %dopar% {
  ...
  source("/Users/peraugust/Library/CloudStorage/OneDrive-UniversitetetiOslo/project1/simulations/HDCD_old/SUBSET/main.R")
...
library(patchwork)
p1+p3 + plot_layout(ncol = 2, guides = "collect")
